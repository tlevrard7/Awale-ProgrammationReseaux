...
server: awale_server.c $(netDir)/network.h $(netDir)/network.c $(netDir)/server.h $(netDir)/server.c $(netDir)/buffer.h $(netDir)/buffer.c $(pktDir)/packets.h $(pktDir)/packets.c 
	mkdir -p $(binDir)
...
client: awale_client.c $(netDir)/network.h $(netDir)/network.c $(netDir)/client.h $(netDir)/client.c $(netDir)/buffer.h $(netDir)/buffer.c $(pktDir)/packets.h $(pktDir)/packets.c
	mkdir -p $(binDir)
